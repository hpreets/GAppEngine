...
public interface NotificationPort {
    ...
    @RequestWrapper(localName = "notifications", targetNamespace = "http://soap.sforce.com/2005/09/outbound", className = "com.sforce.soap.outboundmessage.Notifications")
    @ResponseWrapper(localName = "notificationsResponse", targetNamespace = "http://soap.sforce.com/2005/09/outbound", className = "com.sforce.soap.outboundmessage.NotificationsResponse")
    public boolean notifications(
        ...
        List<ContactNotification> notification);
